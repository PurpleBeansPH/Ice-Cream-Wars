...
public class DragonSlayer extends GameObject {
	...
	public DragonSlayer (int x, int y,ID id, Handler handler) {
		...
		if(id == ID.EnemyDragonSlayer)
			velX = -2;
		else
			velX = 2;
		
		image = new BufferedImageLoader();
		SpriteSheet = new SpriteSheet(image.loadImage("res/Dragonslayer_Walk.png"));
		SpriteSheet.grabImage(1, 2, 64, 64);
		SpriteSheet2 = new SpriteSheet(image.loadImage("res/EDragonslayer_Walk.png"));
